...
* JSON 解码 (comments are supported)
* JSON 编码 (with optional indentation)
...
JsonObject& root = jsonBuffer.createObject();    //创建对象
root["sensor"] = "gps";
root["time"] = 1351824120;

JsonArray& data = root.createNestedArray("data");  //创建嵌套数组
data.add(48.756080, 6);  // 6 是打印的小树点位数
data.add(2.302038, 6);   // 默认打印两位小数
